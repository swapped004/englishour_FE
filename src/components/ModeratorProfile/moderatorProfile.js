                ...
                <div className="profile-nav col-md-3">
                    <div className="panel">
                        ...
                        <ul className="nav nav-pills nav-stacked">
                            ...
                            <li><a href="#" onClick={handleNotification}> <i className="fa fa-calendar"></i> Notification <span className="label label-warning pull-right r-activity">{Exinfo.length}</span></a></li>
                        </ul>
                    </div>
                </div>
