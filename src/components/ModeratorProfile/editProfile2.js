...
const EditProfile2 = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div className="popup_container2"></div>
            <div className="modal">
                ...
                <div className="input-block">
                    ...
                    <form  onSubmit={handleSubmit}>
                        {formValues.map((element, index) => (
                            <div classNameName="form-inline" key={index}>
                            <label>Name</label>
                        ...
                        <div classNameName="button-section">
                            <button classNameName="button add" type="button" onClick={() => addFormFields()}>Add</button>
                            <button classNameName="button submit" type="submit">Submit</button>
                        </div>
                    </form>
